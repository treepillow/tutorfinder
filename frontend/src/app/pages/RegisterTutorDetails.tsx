          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-xl text-[#2F3B3D]">Subjects & Rates</h3>
                <button
                  type="button"
                  onClick={addSubject}
              ...
              {subjects.map((subject, index) => (
                <div key={subject.id} className="bg-[#FFF2D5] p-6 rounded-2xl space-y-4">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2">
                      <Label className="text-[#2F3B3D]">Hourly Rate (SGD)</Label>
                      <Input
                        type="number"
            ...
            <div className="space-y-2">
              <Label className="text-[#2F3B3D]">Highest Level of Education</Label>
            ...
            {/* Availability */}
            <div className="space-y-4">
              <h3 className="text-xl text-[#2F3B3D]">Availability</h3>
